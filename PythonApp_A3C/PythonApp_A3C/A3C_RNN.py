...
class ACNet(object):
    ...
    def _build_net(self, scope):
        ...
        with tf.compat.v1.variable_scope('critic'):   # only critic controls the rnn update
            ...
            l_c = tf.compat.v1.layers.dense(cell_out, 50, tf.nn.relu6, kernel_initializer=w_init, name='lc')
        ...
        with tf.compat.v1.variable_scope('actor'):  # state representation is based on critic
            l_a = tf.compat.v1.layers.dense(cell_out, 80, tf.nn.relu6, kernel_initializer=w_init, name='la')
